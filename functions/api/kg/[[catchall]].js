...
const SEED_DATA = {
  ...
  articles: {
    nodes: [
      ...
      { id: 'tl-2013', label: 'The Custody Problem', type: 'milestone', graph: 'articles', datetime: '2013-01-01', x: 0.2, y: 0.15, r: 0.035, description: '2013 · Origin. Early Base Chain operators confront the tradeoff between convenience and control.' },
      { id: 'tl-2019', label: 'Hardware Wallet Era', type: 'milestone', graph: 'articles', datetime: '2019-01-01', x: 0.4, y: 0.13, r: 0.035, description: '2019 · Shift. Cold storage becomes standard; recovery phrases enter the mainstream vocabulary.' },
      { id: 'tl-2023', label: 'Social Recovery', type: 'milestone', graph: 'articles', datetime: '2023-01-01', x: 0.6, y: 0.13, r: 0.035, description: '2023 · Evolution. Smart accounts distribute trust across guardians, reducing single points of failure.' },
      { id: 'tl-2026', label: 'The Sovereignty Stack', type: 'milestone', graph: 'articles', datetime: '2026-01-01', x: 0.8, y: 0.15, r: 0.035, description: '2026 · Now. Self-custody becomes a composable layer across the metaverse toolset.' },
