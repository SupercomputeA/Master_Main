...
export const articles: Article[] = [
  {
    ...
    knowledgeGraph: {
      nodes: [
        ...
        { id: "quanta", label: "$QUANTA Token", type: "token" },
      ],
      edges: [
        ...
        { from: "supercompute", to: "quanta", label: "issues" },
      ],
    },
    comments: [
      ...
      { id: "c2", author: "base_builder.eth", avatar: "B", date: "2026-05-19", text: "How does the $QUANTA gate work for TradeDesk access? Is it a flat hold requirement or tiered?", replies: [
        { id: "c2r1", author: "Quanta S", avatar: "Q", date: "2026-05-19", text: "Tiered access. 100 $QUANTA for School, 500 for TradeDesk, 1000 for full agent API access.", replies: [] },
      ]},
    ],
  },
  {
    ...
    knowledgeGraph: {
      ...
      edges: [
        { from: "wallet", to: "quanta", label: "holds" },
        { from: "quanta", to: "school", label: "unlocks 100" },
        { from: "quanta", to: "tradedesk", label: "unlocks 500" },
        { from: "quanta", to: "api", label: "unlocks 1000" },
      ],
    },
    comments: [
  ...
  },
  {
    ...
    knowledgeGraph: {
      nodes: [
        ...
        { id: "quanta", label: "$QUANTA Treasury", type: "token" },
      ...
      edges: [
        ...
        { from: "quanta", to: "aave", label: "allocated to" },
    ...
    comments: [
      { id: "c4", author: "treasury_ops.eth", avatar: "T", date: "2026-05-20", text: "Solid evaluation. We've had $QUANTA allocated to Aave on Base since October and the yields have been consistent. Recommend a 15% allocation increase.", replies: [] },
  ...
  },
  {
    ...
    knowledgeGraph: {
      nodes: [
        ...
        { id: "quanta", label: "$QUANTA Gate", type: "token" },
      ...
      edges: [
        ...
        { from: "newsdesk", to: "quanta", label: "gated by" },
