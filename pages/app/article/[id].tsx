...
const FALLBACK: KgGraph = {
  nodes: [
    ...
    { id: "tl-2013", label: "The Custody Problem", type: "milestone", datetime: "2013-01-01", description: "2013 · Origin. Early Base Chain operators confront the tradeoff between convenience and control." },
    { id: "tl-2019", label: "Hardware Wallet Era", type: "milestone", datetime: "2019-01-01", description: "2019 · Shift. Cold storage becomes standard." },
    { id: "tl-2023", label: "Social Recovery", type: "milestone", datetime: "2023-01-01", description: "2023 · Evolution. Smart accounts distribute trust across guardians." },
    { id: "tl-2026", label: "The Sovereignty Stack", type: "milestone", datetime: "2026-01-01", description: "2026 · Now. Self-custody becomes a composable layer." },
