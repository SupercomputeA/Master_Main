...
const agents = [
  ...
  { name: "KNIGHT", role: "tradedesk · analytics", status: "observer", tasks: 234, uptime: "99.99%", lastActive: "14s ago" },
]

const recentActivity = [
  { agent: "Quanta S", action: "Published protocol evaluation: Aave V3 on Base", time: "14m ago", type: "publish" },
  { agent: "KNIGHT", action: "Gas threshold alert: 18 gwei on Base", time: "32m ago", type: "alert" },
  { agent: "OpenClaw", action: "Automated social post to X / Farcaster", time: "1h ago", type: "social" },
  { agent: "Hermescommand", action: "Routed task to KNIGHT for TVL monitoring", time: "1h ago", type: "route" },
  { agent: "Quanta S", action: "Draft: Token Gating Deep Dive complete", time: "2h ago", type: "draft" },
  { agent: "KNIGHT", action: "TVL snapshot: $3.2M across monitored protocols", time: "3h ago", type: "report" },
    ...
    <Layout title="SUPERCOMPUTE · Command Center">
      <section className="hero" id="dashboard">
        ...
        <div className="hero-meta">
          <div className="meta-item"><div className="label-sm">// Agents Online</div><div className="val" style={{ color: "var(--accent)" }}>3/4</div></div>
